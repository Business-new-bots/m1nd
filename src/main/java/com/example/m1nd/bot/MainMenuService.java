            ...
            if (parts.length == 3) {
                ...
                if ("text".equals(modeCode)) {
                    ...
                    text = assistant + "\n\nЗадайте вопрос специалисту:\n\n" +
                        "Напишите суть вопроса в одном сообщении — я отправлю его активному эксперту, а ответ вернется сюда.";
                } else if ("meeting".equals(modeCode)) {
                    text = assistant + "\n\nЗапрос на встречу:\n\n" +
                        "Опишите цель встречи и удобное время — дальше согласуем детали с экспертом в этом чате.";
                } else {
